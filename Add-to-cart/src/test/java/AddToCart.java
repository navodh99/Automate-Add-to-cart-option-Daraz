...
public class AddToCart {
    ...
    public void addItem() throws InterruptedException {
        ...
        email.sendKeys("kifyclothing@gmail.com");
        Thread.sleep(2000);

        WebElement password = driver.findElement(By.xpath("//input[@type='password']"));
        password.sendKeys("Navoda@925929");
        ...
        if (!colour.isEmpty() && !storage.isEmpty()) {
            ...
            ///html/body/div[10]/div/div[2]/a
            ///html/body/div[10]/div/div[2]/a/i
            WebElement closePopup = driver.findElement(
                    By.xpath("//a[@class='next-dialog-close']")
            );
